...
public class Add extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		{   
                    ...
                    PreparedStatement ps=con.prepareStatement("insert into product(pid,cname,ctype,cdet,qua,fres,vac,idate,contact,address,city,image)values('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+m.get(6)+"','"+m.get(7)+"','"+m.get(8)+"','"+m.get(9)+"','"+m.get(10)+"','"+ms.get(0)+"')");
                    System.out.println(ps);
                    ps.executeUpdate();
                    System.out.println(ps);
                    out.println("<script>"); 			
                    out.println("alert(\"Add Interview Details Succesfully\")");
                    out.println("</script>");
